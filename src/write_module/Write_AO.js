module.exports = function (RED) {
  ...
  function YottaReadAoNode(config) {
  ...
  RED.nodes.registerType("Write_AO", YottaReadAoNode);

  RED.httpAdmin.get("/Write_AO/:command", RED.auth.needsPermission('commandfield.read'), function(req,res) {        
      res.json(moduleData);
  });
};
